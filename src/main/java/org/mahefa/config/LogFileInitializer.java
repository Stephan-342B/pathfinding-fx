 ...
 * over on demand by {@link org.mahefa.service.concurrent.progress.LogCleaner}. The narrative logs
...
public class LogFileInitializer {
    ...
    void attachFileAppenderIfEnabled() {
        ...
        // TRACE = pass everything the loggers already allow (org.mahefa is at DEBUG), so the file
